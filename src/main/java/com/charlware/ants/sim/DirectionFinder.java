...
//            return getDirectionWithPredictableDirection(fromLocation, toLocation);
        ...
        Location[] neighbors = fromLocation.getNeighbors();
        int closest = 0;
        double shortestDistance = neighbors[closest].getDistanceTo(toLocation);
        double distance;
        for(int i = 1; i < neighbors.length; i++) {
            distance = neighbors[i].getDistanceTo(toLocation);
        ...
        return fromLocation.getDirections()[closest];
    }
