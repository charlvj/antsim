...
public class MatrixLocation implements Location {
	...
	public double getDistanceTo(Location otherLocation) {
		if(!(otherLocation instanceof MatrixLocation)) throw new RuntimeException("Not implemented!");
	...
	public MapDirection getDirectionTo(Location otherLocation) {
		...
		if(dx == 0 && dy == 0) {
			...
			// Move horizontally
			switch(sx) {
				case -1: dir = MapDirection.Left; break;
				case 1:  dir = MapDirection.Right; break;
			}
		}
		else {
			// Move vertically
			switch(sy) {
				case -1: dir = MapDirection.Up; break;
				case 1:  dir = MapDirection.Down; break;
			}
		}
		return dir;
	}
